...
export const Timeline: React.FC<TimelineProps> = (props) => {
  ...
  const { changelogHeader, timeline } = data
  ...
  return (
    <div className={cn(className, 'w-full pb-20')} ref={containerRef}>
      <div className="flex flex-col items-start justify-start w-full max-w-sm mb-10">
        {changelogHeader && <RichText data={changelogHeader} enableGutter={false} />}
      </div>
        ...
        {timeline?.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl pl-2 md:pl-20 md:text-5xl font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 sm:pl-[2rem] lg:pl-[13rem] xl:pl-[20rem] w-full">
